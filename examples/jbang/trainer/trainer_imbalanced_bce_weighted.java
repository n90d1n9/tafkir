...
public class trainer_imbalanced_bce_weighted {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("====================================================");
        System.out.println(" Tafkir Imbalanced BCE Weighted Trainer (JBang)");
        System.out.println("====================================================");
        ...
        var evaluation = Tafkir.DL.evaluate(
                model,
                validation,
                Tafkir.DL.bceWithLogitsLoss(positiveWeight)::compute,
                requestedDevice,
        ...
        System.out.println("----------------------------------------------------");
        System.out.printf("positiveWeight=%.6f%n", positiveWeight);
