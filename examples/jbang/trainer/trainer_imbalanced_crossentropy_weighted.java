...
public class trainer_imbalanced_crossentropy_weighted {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("====================================================");
        System.out.println(" Tafkir Imbalanced CrossEntropy Trainer (JBang)");
        System.out.println("====================================================");
        ...
        float[] classWeights = Tafkir.DL.classWeightsFor(3, labels);
        ...
        TrainingSummary summary = Tafkir.DL.fit(
                ...
                80,
                0.06f,
                Tafkir.DL.TrainingPreset.CLASSIFICATION_CROSS_ENTROPY_ADAMW,
                Tafkir.DL.trainingOptions()
                        .device(requestedDevice)
                        .gradientClip(1.0)
                        .crossEntropyClassWeights(classWeights)
        ...
        var evaluation = Tafkir.DL.evaluate(
                model,
                validation,
                Tafkir.DL.crossEntropy(classWeights)::compute,
                requestedDevice,
        ...
        System.out.println("----------------------------------------------------");
        System.out.println("classWeights=" + Arrays.toString(classWeights));
