package tech.kayys.gollek.models.pegasus;
...
@ApplicationScoped
public class PegasusModelFamilyPlugin implements ModelFamilyPlugin {
    ...
    public ModelFamilyDescriptor descriptor() {
        return new ModelFamilyDescriptor(
                ...
                "Pegasus",
                List.of("pegasus"),
                List.of("PegasusForConditionalGeneration", "PegasusModel",
                        "PegasusForCausalLM"),
                ...
                Map.of(
                        ...
                        "origin", "3rdparty/transformers/src/transformers/models/pegasus",
