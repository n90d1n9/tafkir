 ...
 * <p>
 * Embeddings are the foundation of NLP and sequence models. Each vocabulary
 * token
 * is assigned a learnable dense vector representation. During forward pass,
 * token IDs
 * are converted to their corresponding embeddings.
 * <p>
 * The embedding matrix is initialized with a normal distribution (mean=0,
 * std=0.02)
 ...
 * <h3>Shape</h3>
 * <ul>
 * <li><b>Input:</b> arbitrary shape containing integer token IDs (as
 * floats)</li>
...
public class Embedding extends NNModule {
     ...
     *
     * @throws IllegalArgumentException if numEmbeddings or embeddingDim is
     *                                  non-positive
     */
     ...
     *
     * @throws IndexOutOfBoundsException if any token ID is out of range [0,
     *                                   numEmbeddings)
     */
    @Override
