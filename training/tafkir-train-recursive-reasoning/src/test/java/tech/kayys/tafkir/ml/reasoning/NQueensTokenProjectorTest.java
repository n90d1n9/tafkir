...
class NQueensTokenProjectorTest {
    ...
    void projectingNextStateFactoryAttachesDefaultMetadataForRolloutEvaluation() {
        ...
        int[] expectedTokens = NQueensSolution.ofColumns(1, 3, 0, 2).toTokens();
        GramNextStateFactory delegate = (ignoredPrevious, ignoredContext,
                transitionSample) -> new RecursiveReasoningState(
                        "next",
                        0,
                        1,
                        0,
        ...
        NQueensTokenPredictionHead head = (proposed, ignoredContext, ignoredSample,
                problem) -> new NQueensTokenProjectionResult(
                        expectedTokens,
