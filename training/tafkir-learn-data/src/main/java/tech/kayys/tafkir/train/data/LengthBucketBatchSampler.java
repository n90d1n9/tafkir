 ...
 *
 * <p>The sampler returns flat indices because DataLoader owns the final batching step.
 * Internally it still forms batch-sized groups first, then flattens them, so groups
 * remain aligned with the loader's {@code batchSize}.</p>
 */
