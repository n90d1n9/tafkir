...
public final class TrainingReportPromotionGatePackageJUnitXml {
        ...
        public static String render(TrainingReportPromotionGateArtifactPackage.PackageVerification verification) {
                TrainingReportPromotionGateArtifactPackage.PackageVerification resolvedVerification = Objects
                                .requireNonNull(verification, "verification must not be null");
                TrainingReportPromotionGateArtifactPackage.PackageInspection inspection = resolvedVerification
                                .inspection();
                TrainingReportPromotionGateArtifactManifest.ManifestVerification manifest = resolvedVerification
                                .manifestVerification();
                TrainingReportPromotionGateArtifactPackage.SourceSnapshotVerification sourceSnapshots = resolvedVerification
                                .sourceSnapshotVerification();
                String markdown = TrainingReportPromotionGateArtifactPackage
                ...
                appendLine(xml, "<testsuite name=\"alkhawarizm.training.promotion.package\" tests=\"3\" failures=\""
        ...
        private static void testcase(
                        ...
                        String markdown) {
                appendLine(xml, "  <testcase classname=\"alkhawarizm.training.promotion.package\" name=\""
