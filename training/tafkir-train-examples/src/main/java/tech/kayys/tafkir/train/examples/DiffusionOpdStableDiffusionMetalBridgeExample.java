...
/**
 * Minimal bridge example that aligns the safetensor-native Stable Diffusion
 ...
 */
public final class DiffusionOpdStableDiffusionMetalBridgeExample {

    private DiffusionOpdStableDiffusionMetalBridgeExample() {
    }
        ...
        try (AccelTensor accelLatents = AccelTensor.fromFloatArray(
            ...
            try {
                try (AccelTensor accelRoundTrip = bridge.toAccelTensor(coreTensor)) {
                    System.out.println("DiffusionOPD Stable Diffusion Metal bridge example");
