 ...
 *
 * <p>
 * This abstraction exists because DiffusionOPD supervises transition means
 * instead of raw backend-specific denoiser outputs. See arXiv:2605.15055.
 */
public interface TransitionMeanAdapter {

    /**
     * Converts the current noisy state and model prediction into the scheduler-step
     * mean that OPD
    ...
    /**
     * Returns the effective variance associated with the adapted scheduler step at
     * the given
     * timestep.
     */
