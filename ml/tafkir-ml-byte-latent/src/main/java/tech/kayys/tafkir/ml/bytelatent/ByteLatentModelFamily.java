...
public final class ByteLatentModelFamily {
    ...
    public static final String PAPER_CITATION = "Julie Kallini et al., Fast Byte Latent Transformer, arXiv:2605.08044v1 (2026)";
    ...
    public static List<String> recommendedModuleIds() {
        return List.of(
                ...
                "runner:alkhawarizm-runner-byte-latent",
                "trainer:alkhawarizm-trainer-byte-latent");
    }
}
